...
int main(int argc, char **argv) {
    ...
    //I want to check to see if the string inputs ends in a .txt
    //If it does I want to treat this as a file and read in the contents of the file instead and hash them.
